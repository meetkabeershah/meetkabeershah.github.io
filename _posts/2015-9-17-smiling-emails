...
An [email](http://www.smashingmagazine.com/2011/07/email-is-still-important-and-here-is-why/) is one of the first bet a website make to it's users. Till date emails from [this sender](http://nerdspal.com) are so **ugly**  [no-no](https://www.quora.com/Why-do-people-hate-email-so-passionately).
...
A lot of things in [nerdspal](http://nerdspal.com) need redesigning. I'm starting with the most critical ones first.
