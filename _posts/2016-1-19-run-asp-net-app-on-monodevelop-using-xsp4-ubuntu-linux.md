---
layout: post
title: Solve xsp4 web server error for an ASP.NET MVC project on Ubuntu linux using Mono on Monodevelop
---
...
After [setting up Mono.NET on Ubuntu Linux](http://xameeramir.github.io/configure-net-ubuntu-linux/), open a new instance of [Monodevelop](http://www.monodevelop.com/) either from [launcher](https://help.ubuntu.com/stable/ubuntu-help/unity-launcher-intro.html) or [terminal](http://askubuntu.com/a/183777/219603).

In case we're running an [ASP.NET applications on Mono](http://www.mono-project.com/docs/web/aspnet/) using [Monodevelop](http://www.monodevelop.com/) for the first time, [we may receive the below error](http://stackoverflow.com/a/34872143/2404470):
